      ...
      <div className="rounded-xl border border-[var(--border)]/60 bg-gradient-to-br from-blue-50 to-indigo-50 p-6 shadow-sm">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h2 className="text-lg font-bold text-gray-900">Bienvenido a Cargo Tracking</h2>
            <p className="text-sm text-gray-600 mt-1">
              Sistema de rastreo de carga aérea en tiempo real
            </p>
          </div>
        </div>
